...
export const migration019: Migration = {
  ...
  up: (db: Database.Database) => {
    db.exec(`
      ...
      CREATE INDEX IF NOT EXISTS idx_gateway_audit_at ON gateway_audit(occurred_at);
      CREATE INDEX IF NOT EXISTS idx_gateway_audit_user ON gateway_audit(user_id, occurred_at);
      CREATE INDEX IF NOT EXISTS idx_gateway_audit_operation ON gateway_audit(operation, occurred_at);
    `);
  },
};
