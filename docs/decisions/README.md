...
| [ADR-0031](ADR-0031-fork-free-channel-extensions.md) | 通道不 fork 接入（manifest + EXTENSIONS_DIR 加载 + semver 版本门 + 契约门 + fail-open；运营者自控目录，非公开 registry） | Accepted | 2026-06-12 | `channels`, `extensibility`, `plugins`, `fork-free` |
