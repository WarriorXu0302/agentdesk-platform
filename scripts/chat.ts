/**
 * nc — chat with your agent from the terminal.
 *
 * Usage:
 ...
 *
 * Preconditions: host service running, an agent group wired to
...
function main(): void {
  ...
  socket.on('error', (err) => {
    ...
    if (e.code === 'ENOENT' || e.code === 'ECONNREFUSED') {
      console.error(`Agent daemon not reachable at ${socketPath()}.`);
